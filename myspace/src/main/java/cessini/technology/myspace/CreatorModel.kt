...
@EpoxyModelClass
abstract class CreatorModel (user_id:String,private val context: Context): EpoxyModelWithHolder<CreatorModel.CreatorModelHolder>() {
    ...
    @EpoxyAttribute
    lateinit var fragment: SearchUsersFragment

    @EpoxyAttribute
    lateinit var userId: Profile
    val id=user_id
    override fun getDefaultLayout(): Int {
        return R.layout.myspace_view_holder_creators
    }

    override fun bind(holder: CreatorModelHolder) {
        super.bind(holder)
        setSocket(id)
...
class message_(@SerializedName("user_id") val sender_id:String,
