 ...
 */
class HomeFragmentEpoxyController(val mSocket:Socket, val idMe: String, val idOth: String, val chatMessageState: CanLoad) : PagedListEpoxyController<ResponseMessageJson>() {
