...
import cessini.technology.explore.R2;

@EpoxyDataBindingLayouts({R2.layout.user_search_creator_item,
        R2.layout.user_search_friends_item,
        ...
        R2.layout.child_item_room,
        R2.layout.upcoming_myspace,
